jQuery(document).ready(function($) {
	...
	tinymce.PluginManager.add('m59_icon', function(editor, url) {
		...
		// add button
		editor.addButton('m59_icon_list', {
			text: '',
			icon: 'mce-ico m59-icons-icon fa fa-flag',
